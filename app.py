...
pages = [
    ...
    # st.Page("pages/2_EMA_Analysis.py",    title="EMA 分析",       icon="📈"),   # 封存 2026-09-12
    ...
    # st.Page("pages/7_Position_Sizing.py",  title="加碼比例計算器", icon="📉"),   # 封存 2026-09-12
    # st.Page("pages/9_ATR_Pullback_Stats.py", title="ATR 回檔機率", icon="🌡️"),   # 封存 2026-09-12
